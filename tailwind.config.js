...
module.exports = {
  ...
  theme: {
    ...
    borderColor: (theme) => ({
      ...theme('colors'),
      DEFAULT: theme('colors.k', 'currentColor'),
    }),
    ...
    boxShadow: (theme) => ({
      DEFAULT: `0 2px 2px 0 ${theme('colors.k')}`,
      hidden: `0 0 0 0 ${theme('colors.k')}`,
      none: 'none',
    }),
    container: {},
    cursor: {
    ...
    fontSize: {
      ...
      xl: ['19.2px', { lineHeight: '28px' }],
      '2xl': ['24px', { lineHeight: '27.2px' }],
      '3xl': ['28px', { lineHeight: '33px' }],
      '4xl': ['28.8px', { lineHeight: '34px' }],
